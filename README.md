...
<br>
<h3 align="center" style = "font-style:italic; color:#000000;">Creation  Beyond  Imagination</h3>
<h3 align="center" style = "font-style:italic; color:#505050;">Creation  Beyond  Imagination</h3>
<h3 align="center" style = "font-style:italic; color:#999999;">Creation  Beyond  Imagination</h3>
<br>
...
|-------|:----------:|:-----------:|
| `2017.02.` ~ `2023.08.` 	| 서강대학교 학사(졸업), 수학(주전공), 아트&테크놀로지(복수전공) | 서강대학교  |
| `2022.01.` ~ `2022.05.` 	| 교환학생 프로그램 참여 | 미국, Chapman university  |
| `2024.03.` ~  	| 신한투자증권 프로 디지털 아카데미 4기 | 신한투자증권  |


### 프로젝트
- 유니티 게임 'Black Out', FE 개발 
<br>
<img width="50%" src="./black-out.gif">

- 사용자 음성 반응 3D 웹사이트 'Objects in Wonderland', UI 위치 함수 구현 및 이벤트 발생 함수 개발
<br>
<img width="50%" src="./objectsInWonderland.gif">

- 프로세싱(javascript) 기반 미니 육아 게임 개발, FE 개발 및 휴대폰 연동
<br>
...
<a href="https://impartial-plume-a00.notion.site/EIGHT-bb5d2ac74c7041beb2a3ece7830d9cce?pvs=4" style = "color:blue">활동 결과 보러가기</a>
